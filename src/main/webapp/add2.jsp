...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
   ...
   <body>         
<center>
  <div class="enjoy-css2">  Customer Master</div>
<table bstyle="width:100%" cellpadding="25px" cellspacing="25px" >
<form action="add.jsp">
  <tr><td>  <input type="submit"class="enjoy-css" value="Add New Customer"  /></td>
    
</form>
<form action="delete.jsp">
    <td><input type="submit"class="enjoy-css" value="Customer Delete" /></td>
    
</form>
<form action="update.jsp">
    <td><input type="submit"class="enjoy-css" value="Customer Update"  /></td></tr>
