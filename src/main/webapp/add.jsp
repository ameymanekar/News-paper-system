					...
					<ul class="field-list">
						<li class="name">
							...
							<div class="form-input">
									...
									<input type="text" pattern="[A-Z a-z]+" name="name" placeholder="Full Name" style="text-transform:uppercase" required>
						...
						<li> 
							...
							<div class="form-input">
									...
									<input type="text"  name="houseno" placeholder="houseno" required>
  ...
  <%  
             ...
             %>
							...
							<div class="form-input">
									...
									<input type="text" name="delcharges" pattern="[1,2,3,4,5,6,7,8,9,0]{2}" maxlength="2" placeholder="delivery charges" required>
      ...
      %>
									...
									<input type="hidden" value="<% out.print(ft.format(dNow)); %>" name="date" placeholder="Qualification">
