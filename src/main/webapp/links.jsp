        ...
        <table cellspacing="15px" >
        	...
        	<form action="home.jsp" target="f2"> 
     		...
     		<form action="add2.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="Customer Master"/></td></tr></form>
        	
        	<form action="ViewEntries.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="  View Entries   "/></td></tr></form>
        	
        	<form action="FlagStatus.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="  Flag Status    "/></td></tr></form>
        	
        	<form action="BillGeneration.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value=" Bill Generation"/></td></tr></form>
